		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "training",
									"targetURL": "#uiview2project3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiview2project3-display": {
								"semanticObject": "uiview2project3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.view2.project3",
									"url": sap.ui.require.toUrl("ui/view2/project3")
								}
							}
						}
					}
